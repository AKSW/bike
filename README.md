...
Due to the increase in usage of Large Language Models (LLMs) in the task of text extraction we have selected a single fold from the original NatUKE benchmark for the evaluation.
This reduces computational overhead whenever participants want to use fine-tuning or in-context learning since previously each task (5) * evaluation stage (4) * fold (10) needed a separate fine-tuned model.
The chosen evaluation stages for all folds was the third (60% train/40% test), and the fold was randomly chosen using a google spreadsheet.
The folds to be used this year, along with the original non-average baseline results  can be accessed here: [https://drive.google.com/drive/folders/13JcJXaFJhaoi3qx9aBBlfYxqHUKq3qJi?usp=sharing](https://drive.google.com/drive/folders/13JcJXaFJhaoi3qx9aBBlfYxqHUKq3qJi?usp=sharing).
...
- Every competing team should submit their results at the workshop Easychair [https://easychair.org/conferences/?conf=bike2026](https://easychair.org/conferences/?conf=bike2026) using the paper template.
...
- The only information mandatory in the result submission is as follows:
  ...
  - To facilitate your result submission, we prepared a template: [https://www.overleaf.com/read/fzhbcqnctpgd#d2dc06](https://www.overleaf.com/read/fzhbcqnctpgd#d2dc06)
...
- Paper Overleaf Template: [https://www.overleaf.com/read/fzhbcqnctpgd#d2dc06](https://www.overleaf.com/read/fzhbcqnctpgd#d2dc06)
...
- All papers should be submitted to easychair under the link  [https://easychair.org/conferences/?conf=bike2026](https://easychair.org/conferences/?conf=bike2026).
...
Sanju Tiwari, Sharda University, Delhi-NCR, India
...
- [2025 Second Edition](https://aksw.github.io/bike/2025)
